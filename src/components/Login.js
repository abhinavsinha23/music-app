            ...
            <div className="LoginBox">
                ...
                <form onSubmit={loginHandler} className="LoginForm">
                    <label className="LoginLabel">Username
                        <input onChange={(event) => setUsername(event.target.value)}  placeholder="Enter Username" required></input>
                    </label>
                    <br></br>
                    <label className="LoginLabel">Email
                        <input onChange={(event) => setEmail(event.target.value)}  placeholder="Enter Email" required></input>
                    </label>
                    <br></br>
                    <label className="LoginLabel">Password
                        <input type='password' onChange={(event) => setPassword(event.target.value)}   placeholder="Enter Password" required></input>
                    </label>
                    <br></br>
            ...
            <div className="RegisterBox">
                ...
                <form onSubmit={registerHandler} className="RegisterForm">
                    <label className="RegisterLabel">Username &nbsp; 
                        <input onChange={(e) => {setUsername(e.target.value)}}  placeholder="Enter Username"required></input>
                    </label>
                    <br></br>
                    <label className="RegisterLabel">Email &nbsp; 
                        <input  onChange={(e) => {setEmail(e.target.value)}}   placeholder="Enter Email"required></input>
                    </label>
                    <br></br>
